=== Wordpress Pluso ===
Contributors: Pluso
Donate link: share.pluso.ru
Tags: post, media, publish, social, network
...
* Author: [Pluso](http://share.pluso.ru)
* Project URI: <http://share.pluso.ru>
* License: GPL 2. See License below for copyright jots and tittles.

== Short Description ==

Wordpress Pluso plugin adds Pluso social buttons into the site.
...
1.	Download the Wordpress Pluso archive in zip format and
...
2. Adding Wordpress Pluso to the plug-in database
